                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input" id="DOB" name="DOB" data-target="#reservationdate" />
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="Education" name="Education" placeholder="B.com, M.com, etc...">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="Business">Business/Job</label>
                                                <input type="text" class="form-control" id="Business" name="Business" placeholder="Business/Job">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="MaritalStatus">Maritial Stauts</label>
